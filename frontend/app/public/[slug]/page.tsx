...
export default function PublicPropertyPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
            {/* Hero Section */}
            <section className="relative h-96 glass-strong border-b border-border">
                <div className="absolute inset-0 gradient-primary opacity-10"></div>
                <div className="relative h-full flex items-center justify-center text-center p-8">
                    <div>
                        <h1 className="text-5xl font-bold gradient-text mb-4">{property.name}</h1>
            ...
            <div className="max-w-6xl mx-auto p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        {/* Contact Card */}
                        <div className="glass-strong p-6 rounded-lg sticky top-8">
                            <h3 className="text-xl font-semibold mb-4">Contato</h3>

                            <div className="space-y-4">
                                {property.phone && (
                                    <a href={`tel:${property.phone}`} className="flex items-center gap-3 p-3 rounded-lg glass hover:glass-strong transition-all">
                                ...
                                {property.whatsapp && (
                                    <a href={`https://wa.me/${property.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg glass hover:glass-strong transition-all">
                                ...
                                {property.website && (
                                    <a href={property.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg glass hover:glass-strong transition-all">
                            ...
                            {(property.instagram || property.facebook || property.youtube || property.tiktok) && (
                                <div className="mt-6 pt-6 border-t border-border">
                                    ...
                                    <div className="flex gap-3">
                                        {property.instagram && (
                                            <a href={`https://instagram.com/${property.instagram.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass hover:glass-strong transition-all flex items-center justify-center">
                                        ...
                                        {property.facebook && (
                                            <a href={`https://facebook.com/${property.facebook}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass hover:glass-strong transition-all flex items-center justify-center">
                                        ...
                                        {property.youtube && (
                                            <a href={`https://youtube.com/${property.youtube}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass hover:glass-strong transition-all flex items-center justify-center">
                                        ...
                                        {property.tiktok && (
                                            <a href={`https://tiktok.com/@${property.tiktok.replace('@', '')}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full glass hover:glass-strong transition-all flex items-center justify-center">
            ...
            <footer className="mt-16 border-t border-border p-8 text-center text-text-muted text-sm">
                <p>Powered by <span className="gradient-text font-semibold">Hy-fen</span></p>
            </footer>
        </div>
    );
}
